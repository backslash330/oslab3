...
4cpu_batch_experiment(){
    ...
    echo "Ready Processes,Processes in CPU,Blocked processes,Completed processes,Accounted For, Number of CPUs,Exiting at simulation time,TurnaroundTime" > 4cpus_batch_raw.csv
    ...
    do
        ...
        do
            ...
            java Simulator 100000 $i 10000 500 4 > temp.txt
    ...
    echo "Mean Turnaround Time: $avg_turnaround_time" >> 4cpus_batch_stats.csv
    ...
    echo "Standard Deviation of Turnaround Time: $st_dev_turnaround_time" >> 4cpus_batch_stats.csv
