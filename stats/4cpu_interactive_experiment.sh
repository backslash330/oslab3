4cpu_interactive_experiment(){
    ...
    echo "Ready Processes,Processes in CPU,Blocked processes,Completed processes,Accounted For, Number of CPUs,Exiting at simulation time,TurnaroundTime" > 2cpus_interactive_raw.csv
    ...
    echo "Mean Total Processes: $avg_total_processes" >> 2cpus_interactive_stats.csv
    echo "Mean Turnaround Time: $avg_turnaround_time" >> 2cpus_interactive_stats.csv
    ...
    echo "Standard Deviation of Total Processes: $st_dev_throughput" >> 2cpus_interactive_stats.csv
    echo "Standard Deviation of Turnaround Time: $st_dev_turnaround_time" >> 2cpus_interactive_stats.csv
